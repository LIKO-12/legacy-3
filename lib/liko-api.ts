...
import jsonData from './liko-api.json';

export namespace LIKOAPI {
    /**
     ...
     */
    export type SingleLuaType = 'any' | StandardLuaType;

    /**
     * Multiple Lua types specified, but could be a single type too.
     * The custom Lua type can only be specified through this.
     */
    export type MultipleLuaTypes = SingleLuaType | CustomLuaType;

    /**
     * Represents a value type.
     */
    export type LuaType = SingleLuaType | MultipleLuaTypes[];
...
interface Documentation {
     ...
     */
    engineVersion: LIKOAPI.SubVersion,
     ...
     */
    Peripherals: { [peripheralShortName: string]: LIKOAPI.Peripheral }
}
